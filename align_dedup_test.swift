...
(file output) novosort (string novosortdir, file inputFile, string tmpdir, int thr, string... sortoptions) "mytcl" "0.0" [
	"set <<output>> [ mytclsort::novosort <<novosortdir>> <<inputFile>> <<tmpdir>> <<thr>> <<sortoptions>> ]"
];
