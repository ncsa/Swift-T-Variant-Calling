# -*- coding: utf-8 -*-
#
# Swift_T_Variant_Calling documentation build configuration file, created by
...
htmlhelp_basename = 'Swift_T_Variant_Callingdoc'
...
man_pages = [
    (master_doc, 'swift_t_variant_calling', u'Swift_T_Variant_Calling Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Swift_T_Variant_Calling', u'Swift_T_Variant_Calling Documentation',
     author, 'Swift_T_Variant_Calling', 'One line description of project.',
     'Miscellaneous'),
]
