...
#define SWIG_init    Pipingmodule_Init
#define SWIG_name    "pipingmodule"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_runpipe(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 ;
  char **arg2 = (char **) 0 ;
  char **arg3 = (char **) 0 ;
  void *argp1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:runpipe pfd cmd1 cmd2 ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "runpipe" "', argument " "1"" of type '" "int []""'"); 
  } 
  arg1 = (int *)(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_p_char, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "runpipe" "', argument " "2"" of type '" "char **""'"); 
  }
  arg2 = (char **)(argp2);
  res3 = SWIG_ConvertPtr(objv[3], &argp3,SWIGTYPE_p_p_char, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "runpipe" "', argument " "3"" of type '" "char **""'"); 
  }
  arg3 = (char **)(argp3);
  runpipe(arg1,arg2,arg3);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "runpipe", (swig_wrapper_func) _wrap_runpipe, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Pipingmodule_SafeInit(Tcl_Interp *interp) {
