...
2 sample paired end reads  (BWA-mem as aligner, Picard for marking duplicates)
...
Validate that workflow will run if one or more samples fail, but not all.
...
Validate all other features and tools on a 6 sample run
