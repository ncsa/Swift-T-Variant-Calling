...
#H3a data run
swift-t -m slurm -l -V -s settings.sh -u -I $scriptdir/src -r $scriptdir/src/bioapps $scriptdir/src/VariantCalling.swift -runfile=$PWD/H3A_Practice_config/H3ABioNet_Practice_data.runfile | tee $PWD/log
