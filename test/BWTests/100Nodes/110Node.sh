...
export TURBINE_OUTPUT=/scratch/sciteam/jacobrh/purge_exempt/Swift_testing/110Nodes/110_log_directory	# This specifies where the log info will be stored; defaults to one's home directory
...
/projects/sciteam/baib/SwiftTesting/Swift-T-Variant-Calling/src/VariantCalling.swift -runfile=/scratch/sciteam/jacobrh/purge_exempt/Swift_testing/110Nodes/110Node.runfile
