...
# Changed from Justin's original code (Just hard-coded path to Swift/T installation 
VARIANTS_HOME=/projects/sciteam/baib/SwiftTesting/Swift-T-Variant-Calling
